...
/* Macros */
#define USART_DEFAULT_RX_BUFFER_SIZE 256
#define USART_DEFAULT_RX_BUFFER_MASK (USART_DEFAULT_RX_BUFFER_SIZE - 1)
#define USART_DEFAULT_TX_BUFFER_SIZE 256
#define USART_DEFAULT_TX_BUFFER_MASK (USART_DEFAULT_TX_BUFFER_SIZE - 1)
...
class __USART__
{
    public:
        ...
        void    flush    (void);
        uint8_t read     (void);
        int8_t  read     (uint8_t* buffer, uint8_t size, const uint32_t timeout);
        int8_t  read     (uint8_t* buffer, uint8_t size);
